 ...
 while($Arr = mysqli_fetch_array($result)){
   ...
   <?php } ?>
    ...
    <!--paste your body code-->
       ...
       <section class="mbr-section article content10 cid-rReDTdKj6V" id="content10-8">
    

    <div class="container">
        <div class="inner-container" style="width: 68%;">
            <hr class="line" style="width: 25%;">
            <div class="section-text align-center mbr-white mbr-fonts-style display-1" id = "Galary">Galary</div>
            <hr class="line" style="width: 25%;">
        </div>
    </div>
</section>
...
$href='View%20Artwork%20(visitor).php?title=' . $row1['title'] ;
$src=$row1['path'];
$title=$row1['title'];
$pathsArray[]=$src;
