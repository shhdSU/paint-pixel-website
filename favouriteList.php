...
-->
  ...
  <style>
    ...
    ul #li{
      ...
      .item gallery-image mbr-col-md-6 mbr-col-sm-12 mbr-col-lg-4{
          max-height: 100px;
          max-width: 100px;
      }
    #deletebutton{
...
-->
 ...
 echo "<li id='li'><div class='item gallery-image mbr-col-md-6 mbr-col-sm-12 mbr-col-lg-4' >
        <span class = 'item-wrapper' id='item-wrapper$imgRow[0]'><amp-img src= 'Artworks/$imgRow[4]' layout='responsive' width='2px' height='2px' alt='image' class='placeholder-loader lb-image'><a id = 'link+$imgRow[0]' href = 'View%20Artwork%20(visitor).php?title=$imgRow[0]'><span class='placeholder'><em></em><em></em><em></em></span></a><p class='item-sign mbr-fonts-style display-7' style = 'color:black;'>$imgRow[0]<span id = 'deletebutton$$imgRow[0]'><img id = '$imgRow[0]' src = 'delete-cross.png' class = 'deletebutton'></span></p></amp-img></span></div></li>";
        $rowcount = $rowcount+1;
        if($rowcount%3==0){
          echo "</span><span class = 'mbr-row'></span>";
        }      
    }
           echo "</ul></span>";       
           ?>
...
function deleteImage(event){
  ...
  window.open("deleteImagePHP.php?title='"+title+"'");
  }
