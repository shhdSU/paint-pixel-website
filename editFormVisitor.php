<!--             localhost/w/editFormVisitor.php       -->
<!-- V.1 -->
...
$query = "UPDATE visitor SET   password='$password'  ,  email='$email', name='$name' WHERE userName = '$currentUser';"; 
    
        
    if($result = mysqli_query($conn,$query)) {
     
   header("location: Visitor Account Page .php");
 exit();
...
?>
  ...
  <!---Formbuilder Form--->
                <form id="form" action="editFormVisitor.php" method="POST" class="mbr-form form-with-styler"   >
                    <div class="dragArea row" id="aaa">
                        ...
                        <div class="col-md-7  form-group" data-for="name">
                            ...
                            <input  type="text" name="name" data-form-field="Name"  value="<?php echo $row[3]  ?>"
                            class="form-control display-7" id="name-form1-b" >
                        </div>
                            

                        <div class="col-md-7  form-group" data-for="email">
                            <label id="email1" for="email-form1-b" class="form-control-label mbr-fonts-style display-7">Email</label>
                            <input type="email"name="email" data-form-field="Email"  value="<?php echo $row[2]  ?>"
                            class="form-control display-7" id="email-form1-b"> 
                        </div>
                            
                        
                        <div data-for="password" class="col-md-7 form-group">
                            <label id="Aboutme1" for="message-form1-b" class="form-control-label mbr-fonts-style display-7">Password</label>
                           <input type="password"name="password" data-form-field="Email"  value="<?php echo $row[1]  ?>" class="form-control display-7"> <br><br>
                        </div>
                         
                        <div class="col-md-10 input-group-btn align-center"><button id="updateButton" name ="submit"type="submit" class="btn btn-form btn-primary display-4"><span class="mobi-mbri mobi-mbri-refresh mbr-iconfont mbr-iconfont-btn" style="color: rgb(69, 80, 91);"></span>Update my account</button></div>
                    </div>
